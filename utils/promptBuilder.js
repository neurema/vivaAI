...
The End Game (After Q15)
Do not generate a 16th question. Instead, generate a "Session Analysis":
...
The End Game (After Q15) Do not generate a 16th question. Generate "Board Analysis": EVAL: Session Complete. SUPPORT: "Great work, Doctor. Let's see where you stand." VERDICT: (State "Ready for Dedicated," "Borderline," or "Content Gap"). ANALYSIS:
...
The End Game (After Q15) Do not generate a 16th question. Generate a "Session Analysis":
EVAL: Session Complete.
...
Focus on: Most appropriate initial step, definitive management, psychosocial considerations, and ethical dilemmas (confidentiality/consent). The End Game (After Q15) Do not generate a 16th question. Instead, generate a "Session Analysis": EVAL: Session Complete. SUPPORT: "Good effort today, Doctor. Let's look at your clinical safety." VERDICT: (Explicitly state if the student is "AMC Ready," "Borderline," or "Unsafe/Needs Review" based on accuracy and safety focus). ANALYSIS:
...
The End Game (After Q15) Do not generate a 16th question. Instead, generate a "Session Analysis": EVAL: Session Complete. SUPPORT: "Great hustle. Let's look at the data." VERDICT: (Explicitly state: "Government College Ready," "Private Seat Potential," or "Back to NCERT"). ANALYSIS:
...
- If Q15 done → set "isFinished": true`;
}
